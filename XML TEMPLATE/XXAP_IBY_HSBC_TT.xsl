          ...
          <PmtInf>
            ...
            <xsl:for-each select="key('contacts-by-LogicalGroupReference', PaymentNumber/LogicalGroupReference)">
              <CdtTrfTxInf>
				...
				<xsl:if	test="not(Payee/SupplierDescriptiveFlexField/Attribute2='')">
								<xsl:choose>
									<xsl:when
										test="(PayeeBankAccount/BankAddress/Country='CN')">
										  <RgltryRptg>
											<Dtls> 
											  <Inf>
											   <xsl:value-of select="Payee/SupplierDescriptiveFlexField/Attribute2"/>
											  </Inf>
											</Dtls>
										  </RgltryRptg>
									</xsl:when>
				...
				<xsl:if	test="not(Payee/ContactInfo/ContactLocators/EmailAddress='')">				
						...
						<RmtInf>
							<xsl:if	test="not(Payee/SupplierDescriptiveFlexField/Attribute2='')">
								<xsl:choose>
									<xsl:when
										test="(PayeeBankAccount/BankAddress/Country='IN')">
											<Ustrd>
												<xsl:value-of select="Payee/SupplierDescriptiveFlexField/Attribute2"/>
											</Ustrd>
									</xsl:when>
								...
								<xsl:choose>
									<xsl:when
										test="(PayeeBankAccount/BankAddress/Country='MY')">
											<Ustrd>
												<xsl:value-of select="Payee/SupplierDescriptiveFlexField/Attribute2"/>
											</Ustrd>
									</xsl:when>
								...
								<xsl:choose>
									<xsl:when
										test="(PayeeBankAccount/BankAddress/Country='PH')">
											<Ustrd>
												<xsl:value-of select="Payee/SupplierDescriptiveFlexField/Attribute2"/>
											</Ustrd>
									</xsl:when>
