...
public class SuppliersSVOImpl extends OAViewObjectImpl 
{

  /**
   * Oracle Applications internal source control identifier
   */
  public static final String RCS_ID="$Header: SuppliersSVOImpl.java 120.2 2005/07/30 09:26:50 atgops1 noship $";
  /**
   * Oracle Applications internal source control identifier
   */
