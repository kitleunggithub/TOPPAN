...
{
  protected static final int MAXATTRCONST = EntityDefImpl.getMaxAttrConst("oracle.apps.fnd.framework.toolbox.schema.server.PurchaseOrderLineEO");
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (oracle.apps.fnd.framework.server.OAEntityDefImpl)EntityDefImpl.findDefObject("mycompany.oracle.apps.fnd.framework.toolbox.schema.server.MyCompanyPurchaseOrderLinesEO");
    }
   ...
   */
  public static Key createPrimaryKey(oracle.jbo.domain.Number lineId)
  {
